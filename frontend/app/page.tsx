              ...
              <div className="flex justify-center ft:justify-start text-base ss:text-xl mt-6 ml-96">
                ...
                >
                  <div className="flex items-center justify-center">
                    <p className="text-[12px] font-bold px-2">
                      Create your Project
                    </p>
                  </div>
                </button>
                ...
                <button
                  className="bg-blue-100 w-40 text-blue-800 rounded-full ml-4 p-2 py-4 hover:bg-blue-200"
                  onClick={() => {
                    if (true) {
                ...
                >
                  <p className="text-[12px]">Browse Project</p>
                </button>
              </div>
            </div>
          </div>
